...
use PerfBundle\Entity\Products;
use PerfBundle\Form\ProductsType;
...
class ProductsController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $products = $em->getRepository('PerfBundle:Products')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('PerfBundle\Form\ProductsType', $product);
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('products_show', array('id' => $products->getId()));
        }
    ...
    {
        $deleteForm = $this->createDeleteForm($product);
        $editForm = $this->createForm('PerfBundle\Form\ProductsType', $product);
